...
public static ArrayList<String> parse_lang(String lang) throws FileNotFoundException, IOException
{
    ArrayList<String> letters = new ArrayList<String>(); // Create an ArrayList object

    //System.out.println("enter which language: en / es");
    
    /** Using Scanner for Getting Input from User */ Scanner in = new Scanner(System.in);
    String file = in.nextLine();
        ...
        try (BufferedReader csv = new BufferedReader(new FileReader(lang+".csv"))) {
            ...
            /** Eat the first two lines of extraneous input */
            row = csv.readLine();
            row = csv.readLine();
